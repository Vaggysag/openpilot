...
char radar_VIN[] = "5YJSA1E11GF150353"; //leave empty if your radar VIN matches the car VIN (This is Vaggy's radar VIN, change it to yours)
...
int radarPosition = 1; //Vaggy's setting - change for your car
int radarEpasType = 3; //Vaggy's setting - change for your car
