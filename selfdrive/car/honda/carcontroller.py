...
class CarController(object):
  ...
  def update(self, enabled, CS, frame, actuators, \
    ...
    if (frame % 10) == 0:
      idx = (frame//10) % 4
      can_sends.extend(hondacan.create_ui_commands(self.packer, pcm_speed, hud, CS.CP.carFingerprint, CS.is_metric, CS.CP.radarOffCan and (not CS.useTeslaRadar), CS.CP.openpilotLongitudinalControl, idx))
