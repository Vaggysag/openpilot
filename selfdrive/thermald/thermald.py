...
CURRENT_TAU = 5.   # 5s time constant
DAYS_NO_CONNECTIVITY_MAX = 69  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 60  # send an offroad prompt after 4 days with no internet
