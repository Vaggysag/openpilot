...
STARTING_BRAKE_RATE = 1.  # brake_travel/s while releasing on restart
BRAKE_STOPPING_TARGET = 1.9  # apply at least this amount of brake to maintain the vehicle stationary
